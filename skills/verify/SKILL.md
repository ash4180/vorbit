...
If the user supplied an external artifact, read `_shared/mcp-tool-routing.md`. Linear is the canonical PRD source; pasted acceptance criteria and local descriptions remain valid read-only inputs.
