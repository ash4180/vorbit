...
1. Read `_shared/mcp-tool-routing.md`; verb names describe intent — never substitute an operation name remembered from another runtime
...
1. Resolve the spec folder and run the write guards per `../_shared/spec-files.md`: worktree root, current branch, protected-branch check, `.gitignore` line.
