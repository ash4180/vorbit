...
5. UI/UX asks: define the key animations and micro-interactions of the recommended approach, following `references/motion-principles.md` (relative to this skill). Name concrete candidate effects from `../_shared/design-knowledge/motion-library.md` and respect its performance principles.
