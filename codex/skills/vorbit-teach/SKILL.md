...
2. Read `../vorbit-shared/workflows/teach.md`.
3. Load the applicable durable Vorbit rules for the current project and Codex agent scope.
4. Then follow the teach workflow: pick the mode, build the decision card or word lesson, keep every fact, end with one check line.
