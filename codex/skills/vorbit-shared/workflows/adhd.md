<!-- GENERATED from skills/adhd/SKILL.md — edit the canonical file, then run: python3 -m vorbit_core.project_skills --write -->

# ADHD Output Mode

Adapted from [i-have-adhd](https://github.com/ayghri/i-have-adhd) by ayghri (MIT).

Read and follow `../references/execution-contract.md` before applying this style.
