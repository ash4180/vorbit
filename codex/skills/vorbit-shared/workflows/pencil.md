...
10. Phase 6 - Write `.claude/rules/pencil.md` with stack, screen presets, code generation rules, Pencil mockup rules, component IDs, token usage map, and layout patterns.
