...
6. Treat repository instructions and project rules as policy. Treat Codex-local rules and UI/performance skills as conditional guidance that cannot replace the repository's established stack.
