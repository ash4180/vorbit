...
6. Before UI coding, write an FE architecture blueprint: mockup block -> Reuse/Adapt/Create matrix, component hierarchy, data/API contract, state ownership, design-system mapping, test seams. Search existing components/compositions/hooks/API helpers before choosing `Create`.
...
9. Treat project-shared Vorbit rules as repo policy. Treat Codex agent-local Vorbit rules as guidance for avoiding repeat Codex mistakes.
