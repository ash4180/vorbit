---
description: question step by step
---
...
- You must use the /ask prompt tool for every question.
- DO NOT render markdown checkboxes.
- Do not show the next question until the user reply
- State Tracking: Maintain a counter (e.g., Progress: [1/10]) in the UI header.
...
- Only after user reply, move to Question 2. use standard chat text to ensure the 'Enter' key works."
