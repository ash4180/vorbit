# Vorbit Runtime Contract for Gemini
...
2. Resolve `GEMINI_HOME` from the environment, defaulting to `~/.gemini`.
3. Run:
...
3. repository instructions such as `GEMINI.md` or `AGENTS.md`;
4. project-scoped shared Vorbit policy;
5. universal shared Vorbit policy;
6. project-scoped Gemini guidance;
7. universal Gemini guidance;
8. workflow defaults.
